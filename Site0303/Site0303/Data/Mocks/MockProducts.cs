...
namespace Site0303.Data.Mocks
{
    ...
    {
        private readonly IAllCategories1 _category1 = new MockCategory1();
            ...
            get
            {
                return new List<Product>
                {
                    new Product
                    {
                         ...
                         IsAviable=true,
                         IsFavorite=false,
                         Category1=_category1.AllCategories1.First(),
                         Price=2000
                    },
                    new Product
                    {
                    ...
                    new Product
                    {
                         ...
                         IsAviable=true,
                         IsFavorite=true,
                         Category1=_category1.AllCategories1.Last(),
                         Price=1100
                    },
                    new Product
                    {
        ...
        public IEnumerable<Product> GetFavProducts => GetAllProducts.Where(x => x.IsFavorite == true && x.IsAviable == true);

        public Product GetProduct(int ProductId) => GetAllProducts.FirstOrDefault(i => i.Id == ProductId);
    }
}
